...
namespace Goods2
{
    public partial class Main : Form
    {
      //  private SqlConnection connect = null;
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch(tabControl1.SelectedIndex)
            {
                case 0:
                    ...
                    Main.ActiveForm.Size = new Size(tabControl1.Size.Width + 6, tabControl1.Size.Height + 6);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    Main.ActiveForm.Size = new Size(tabControl1.Size.Width + 6, tabControl1.TabPages[2].Size.Height + 6);
                    break;
                case 3:
        ...
        {
            this.Refresh();
            this.show_PurchaseTableAdapter.Fill(this.kleinkindDataSet.Show_Purchase,"","");
        ...
        {
            this.Refresh();
            this.show_SaleTableAdapter.Fill(this.kleinkindDataSet.Show_Sale,"","");
        ...
        private void fillToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.show_PurchaseTableAdapter.Fill(this.kleinkindDataSet.Show_Purchase, startPeriodToolStripTextBox.Text, endPeriodToolStripTextBox.Text);
            }
        ...
        private void fillToolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                this.show_SaleTableAdapter.Fill(this.kleinkindDataSet.Show_Sale, startPeriodToolStripTextBox1.Text, endPeriodToolStripTextBox1.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
