    ...
    public partial class StartForm : Form
    {
      //  private SqlConnection connect = null;
        ...
        private void tabControl1_Selected(object sender, TabControlEventArgs e)
        {
            ...
            //{
            //    tabControl1.Size = new Size(show_GoodsDataGridView.Size.Width + 9, show_GoodsDataGridView.Size.Height + 29);
            //    StartForm.ActiveForm.Size = new Size(show_GoodsDataGridView.Size.Width + 9 + 16, show_GoodsDataGridView.Size.Height + 29 + 54);
            //    MessageBox.Show("Grid " + show_GoodsDataGridView.Size + "\nControl " + tabControl1.Size + "\nForm " + StartForm.ActiveForm.Size);
            //}
            //if (tabControl1.SelectedTab == tabControl1.TabPages[1])
            //{
            //    tabControl1.Size = new Size(show_PurchaseDataGridView.Size.Width + 9, show_PurchaseDataGridView.Size.Height + 29);
            //    StartForm.ActiveForm.Size = new Size(show_PurchaseDataGridView.Size.Width + 9 + 16, show_PurchaseDataGridView.Size.Height + 29 + 54);
            //    MessageBox.Show("Grid " + show_PurchaseDataGridView.Size + "\nControl " + tabControl1.Size + "\nForm " + StartForm.ActiveForm.Size);
            //}
            //if (tabControl1.SelectedTab == tabControl1.TabPages[2])
            //{
            //    tabControl1.Size = new Size(show_SaleDataGridView.Size.Width + 9, show_SaleDataGridView.Size.Height + 29);
            //    StartForm.ActiveForm.Size = new Size(show_SaleDataGridView.Size.Width + 9 + 16, show_SaleDataGridView.Size.Height + 29 + 54);
            //    MessageBox.Show("Grid " + show_SaleDataGridView.Size + "\nControl " + tabControl1.Size + "\nForm " + StartForm.ActiveForm.Size);
            //}
            //if (tabControl1.SelectedTab == tabControl1.TabPages[3])
            //{
            //    tabControl1.Size = new Size(show_ClientsDataGridView.Size.Width + 9, show_ClientsDataGridView.Size.Height + 29);
            //    StartForm.ActiveForm.Size = new Size(show_ClientsDataGridView.Size.Width + 9 + 16, show_ClientsDataGridView.Size.Height + 29 + 54);
            //    MessageBox.Show("Grid " + show_ClientsDataGridView.Size + "\nControl " + tabControl1.Size + "\nForm " + StartForm.ActiveForm.Size);
            //}
            //StartForm.ActiveForm.Size = new Size(tabControl1.Size.Width + 16, tabControl1.Size.Height + 54);
        }
